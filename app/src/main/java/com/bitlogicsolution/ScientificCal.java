        ...
        switch (v.getId()) {
            ...
            case R.id.toggle:
                ...
                if (toggleMode == 1) {
                    ...
                    sin.setBackgroundColor(getResources().getColor(R.color.background));
                    cos.setText(R.string.cosinv);
                    cos.setBackgroundColor(getResources().getColor(R.color.background));
                    tan.setText(R.string.taninv);
                    tan.setBackgroundColor(getResources().getColor(R.color.background));
